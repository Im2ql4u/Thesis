...
counts are independent of $N$, since interactions enter through permutation-equivariant
features rather than per-particle weights, and they are not the widths of the architecture
...
informative. Radial localisation---expansion, shell separation, falling width-to-radius
ratio, classical force balance---develops progressively from $\omega=1$ down.
