...
better nodes in the network would explain it; but so would a convention difference in the
Hamiltonian, an extrapolation or sampling error on either side, or an error in the chain of
compilations through which the reference reached us, and we cannot tell these apart. A
...
for $N\ge6$ no external value exists and those states are predictions.
