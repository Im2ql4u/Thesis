...
networks, and physics-informed neural networks---providing the underpinnings for how these
methods apply to quantum many-body problems. #abundant writing
...
physics-informed approaches discussed later.  #we use unsupervised? when?
