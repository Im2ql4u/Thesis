...
dimension of the wavefunction; it is a property of the (architecture, parameterization,
normalization) triple. We use it accordingly---as a comparison between fixed
...
The hyperbolic tangent is zero-centered, which often improves optimisation.  
...
\section{Expressivity, approximation, and generalization}
