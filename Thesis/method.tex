...
\begin{itemize}
  ...
  \item \textbf{CG-SR}: the same step solved matrix-free by preconditioned conjugate
    gradients, with Tikhonov damping and a trust-region cap. It converges faster where $S$
    is well conditioned and becomes unstable at weak confinement, where $S$ is nearly
    singular.
\end{itemize}
