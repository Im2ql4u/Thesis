...
\begin{table}[htbp]
  \centering
  \caption[Ground-state energies against the available references]{Residual-based pretraining + SR tail. Reference energies and our PINN+BF
...
\begin{figure}[htbp]
  ...
  \caption[Relative deviation from the DMC references]{Relative deviation of PINN+BF ground-state energies from DMC
...
\begin{table}[htbp]
  \centering
  \caption[Best energies from collocation-assisted training]{Best ground-state energies from collocation-assisted training.
...
\begin{figure*}[htbp]
  ...
  \caption[One-body densities at strong and weak confinement, $N=2,6,12$]{One-body densities for $N=2,6,12$ at $\omega=1.0$ (top) and
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption[One-body densities at strong and weak confinement, $N{=}20$]{One-body densities for $N{=}20$ at strong and weak confinement.
...
\begin{table}[t]
\centering
\caption[Correlator--backflow coupling diagnostics]{PINN--CTNN coupling diagnostics (CTNN ansatz).
