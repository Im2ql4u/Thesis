...
We first show that the trained states agree closely with every external energy reference
that exists for this system---an agreement rather than an independent validation, and one
that stops at $\omega=0.1$ for $N\ge6$, below which the energies are predictions. That
