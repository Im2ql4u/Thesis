...
This section introduces the structural diagnostics conceptually---what each marker
means and why it detects Wigner order; the precise computational procedures used in
this thesis (estimators, thresholds, and stability protocol) are collected in the
Analysis chapter (Chapter~\ref{ch:analysis}).
...
We form the normalised radial probability in $d{=}2$,
\(
P(r)\propto r\,g(r),
\)
...
$(2,10)$ exhibits very tight inner order ($|\Phi_2|\!\approx\!0.73$) with a softer outer ring ($|\Phi_{10}|\!\approx\!0.42$), and $(1,11)$ has weak outer order and a softly vibrating centre—precisely the \emph{rotating Wigner molecule} (RWM) picture of fluctuating orientations across near-degenerate shellings.\cite{Egger_1999,manninen2007metalclustersquantumdots}
