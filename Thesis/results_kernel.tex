...
One caveat applies throughout. Quantities living on a single component of the ansatz, such
as the backflow's rank or its displacement magnitude, are gauge-like: they are fixed by the
training route rather than by the state. \S\ref{sec:synthesis} identifies the observables
that are not.
