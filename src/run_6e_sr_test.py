...
if __name__ == "__main__":
    ...
    print("CTNN is FRESH (untrained), bf_scale=0.7")
    ...
    print("  500 steps, step_size=0.01, damping=1e-2")
    print(f"{'='*65}")
    sys.stdout.flush()
    ...
    print(
        f"  after SR 500 steps               E={r1['E_mean']:.6f} +/- {r1['E_stderr']:.6f}  err={err1:.2f}%"
    )
