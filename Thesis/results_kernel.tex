...
rigid common shift (rank~1)---while the CTNN's copresheaf transport holds the full-rank
...
response the single-round baseline instead collapses to a rigid common shift
...
single-round-message network collapses to a rigid common shift and its energy fails---at
