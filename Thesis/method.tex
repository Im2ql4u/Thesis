...
$d_{\rm eff}\le r_{\rm eff}$ always, with equality only for a flat spectrum. Chapter
\ref{ch:results} reports $r_{\rm eff}$ for feature covariances and Chapter~\ref{ch:kernel}
