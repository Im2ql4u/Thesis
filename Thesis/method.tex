...
strong confinement, which is why the exact value is used throughout. A five-particle ring with
no angular order whatever returns $|\Phi_5|\approx0.40$. We therefore report $|\Phi_n|$ together with its ratio to this null
