...
\begin{figure}[htbp]\centering
  ...
  is scaled from $20$k to $164$k parameters. Capacity does not explain it; the comparison is
  at the parametrisation and normalisation conventions described in the text, on which
  $d_{\mathrm{eff}}$ depends.}
...
does hold the backflow architecture fixed, is what links the two. What none of it establishes is that the two
...
at every confinement is a robust one. What follows is a mechanism for why the difference
