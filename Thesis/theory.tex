...
2D harmonic-oscillator orbitals as the one-particle basis (Cartesian in our
implementation, or the equivalent polar Fock--Darwin functions), which respect the shell
...
same filled subspace as the polar Fock--Darwin basis, so the reference determinant is
identical in either. Filling from the bottom yields the \emph{closed-shell} electron numbers
\[
