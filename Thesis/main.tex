...
\newcommand{\chapterepigraph}[3]{%
  ...
  \raggedleft\itshape #1\par\smallskip
...
\newcommand{\thesisepigraph}[3]{%
  ...
  \raggedleft\large\itshape #1\par\medskip
  \normalfont\color{myaccent}\textsc{#2}\par
  \normalfont\footnotesize\color{black}#3
  \end{minipage}
  \end{flushright}
...
someone else's.}{Fyodor Dostoevsky}{\textit{Crime and Punishment}, Part III,
Chapter I (Constance Garnett translation)}
\include{preface}
\tableofcontents
