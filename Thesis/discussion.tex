...
\textbf{\textcolor{red}{[TODO: Tables fnet-geometry-omega-big and fnet-geometry-wigner are undefined---create or re-label]}}.
...
$\sim 10\text{--}22$ \textbf{\textcolor{red}{[TODO: Table bf-geometry-smallomega is undefined---create or re-label]}}, with relatively
...
\textbf{\textcolor{red}{[TODO: Table bf-energetics-smallomega is undefined---create or re-label]}}. Thus, many spatial modes contribute
...
must supply: a \emph{conventional}, per-particle backflow does not fall idle so
...
only the inter-particle messages can express it. Second, the ranks and displacement
...
between a per-particle and a message-passing backflow---not the component ranks
themselves.
...
\begin{itemize}
  ...
  \item In the \emph{deep Wigner} regime (ultra-weak traps such as
        ...
        \emph{kind} of backflow, however, still matters---a per-particle network
        collapses and loses accuracy exactly where a message-passing one holds full
        rank and does not (Chapter~\ref{ch:kernel}).
\end{itemize}
