...
bf = BackflowNet(d_in, msg_hidden=msg_hidden, msg_layers=msg_layers, hidden=hid, layers=layers, act="silu")
...
print(f"CTNN: node_hidden={node_hidden}, edge_hidden={edge_hidden}, msg_layers(embed)={msg_layers_c}, msg_layers(update)={msg_layers_eu}, node_layers={layers_c}, use_spin={use_spin}")
ctnn = CTNNBackflowNet(d_in, msg_hidden=edge_hidden, msg_layers=msg_layers_eu, hidden=node_hidden, layers=layers_c, act="silu", use_spin=use_spin, omega=1.0)
