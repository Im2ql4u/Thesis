...
\sisetup{
  ...
  exponent-mode       = input, % don't auto-normalize exponents
  round-mode          = places,
...
\title{Neural Variational Wavefunctions for Two-Dimensional Quantum Dots:\\
       Ansatz Design, MCMC-Free Training, and Wigner-Molecule Diagnostics}
