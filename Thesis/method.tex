...
\hline
\multirow{2}{*}{\makecell[l]{Physics production\\ (\S\ref{sec:energy-overview})}}
  & separable, width $128$, $2$ layers, $54$k & conventional, msg $128$, node $128\times3$, $51$k & $105$k \\
  & \emph{(as above)}                         & message-passing, same widths, $182$k             & $236$k \\
\hline
\multirow{2}{*}{\makecell[l]{Architecture study\\ (\S\ref{sec:kernel-q1})}}
  & separable, pair-MLP $64\times4$, out $32$, $47.7$k & \multirow{2}{*}{\emph{as production; not matched}} & \multirow{2}{*}{---} \\
  & message-passing, node/edge $32$, bottleneck $16$, $2{+}2$ rounds, $79.8$k & & \\
\hline
\multirow{2}{*}{\makecell[l]{Collocation\\ (\S\ref{sec:kernel-mcmcfree})}}
