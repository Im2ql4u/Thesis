...
answer in one corner of the phase diagram and parts company with it in the next. Three unrelated puzzles, on the face of it. They have one answer, and it is
geometric.
...
all. The chapter follows them in that order.
...
(Table~\ref{tab:collocation}). Why it works, where it stops, and what the stopping is made of, follow below.
...
Which of the numbers above can be leaned on is not obvious, and the answer is not
flattering to all of them.
...
the training took and not the state it reached. The worry is not hypothetical. Every claim that reversed during this project was of
this kind---the
...
Rank is not on that list. It runs through this chapter as the clearest \emph{signature}
of the mechanism---a field collapsing onto a single mode is easy to see. What carries the
finding is the half percent of energy that collapses with it.
